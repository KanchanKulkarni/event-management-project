                            ...
                            <div class="tab-pane active" id="Login">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                      UserName</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="usrname" name="username" placeholder="user name" />
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane" id="Registration">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<div class="row">
                                            <div class="col-md-12">
                                                <input type="text" name="lstname" class="form-control" placeholder="Last Name" />
                                            </div>
                                        </div>
                                    </div>
								</div>
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" name="email" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" placeholder="Email" />
                                    </div>
                                </div>
								<div class="form-group">
								...
								<div class="form-group">
                                    <label for="confpassword" class="col-sm-2 control-label">
                                ...
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Mobile</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="mobile" name="phone"	maxlength="10" pattern="[1-9]{1}\d{9}" placeholder="Mobile" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="address" class="col-sm-2 control-label">
                                        Address</label>
                                    <div class="col-sm-10">
                                        <input type="textarea" row="4" cols="50" class="form-control" id="address" 	name="address"	placeholder="Where you stay" />
                                    </div>
                                </div>
	...
	<div class="main-banner">
				...
				<div class="flexslider">
						...
						<li>
							<?php
                             ...
                             $stmt = $conn->prepare("SELECT * from event where eventid=1");
                             $stmt->execute();
						...
						<li>
							<?php
                             $conn = new mysqli('localhost','root','root','eventmanagement');
                             $stmt = $conn->prepare("SELECT * from event where eventid=2");
                             $stmt->execute();
                             $result = $stmt->get_result();
		 ...
		 <div class="clearfix"></div>
			...
			<li>
				<?php
                             $conn = new mysqli('localhost','root','root','eventmanagement');
                             $stmt = $conn->prepare("SELECT * from event where eventid=3");
                             $stmt->execute();
                             $result = $stmt->get_result();
			...
			<li>
				<?php
                             $conn = new mysqli('localhost','root','root','eventmanagement');
                             $stmt = $conn->prepare("SELECT * from event where eventid=4");
                             $stmt->execute();
                             $result = $stmt->get_result();
